...
export const DataExplorerEl = ({ country }: { country: string }) => {
  ...
  return (
    <>
      ...
      {/*
    <div className='mx-auto my-8 w-full max-w-360'>
      <VisualizationWidget>
        <VisualizationWidgetHeader
          defaultValue='workAndEmployment'
          onChange={(d) => setSelectedCategory(d)}
        >
          ...
          <VisualizationWidgetHeaderItem value='livingCondition'>
            <Home size={24} />
            Living condition
          </VisualizationWidgetHeaderItem>
        ...
        <VisualizationWidgetBody>
          <VisualizationWidgetBodyContent>
            <div className='h-96 w-full bg-surface-sm' />
          </VisualizationWidgetBodyContent>
        </VisualizationWidgetBody>
      </VisualizationWidget>
    </div> */}
